...
//		iedriver.get("https://www.seleniumhq.org/");
		...
		chromedriver.findElement(By.xpath("//div/ul/li[@id='menu_download']"));
		Thread.sleep(2000);
		chromedriver.findElement(By.xpath("//div/ul/li[@id='menu_documentation']"));
		Thread.sleep(2000);
		chromedriver.findElement(By.xpath("//div/ul/li[@id='menu_support']"));
		Thread.sleep(2000);
		
		try{
		chromedriver.findElement(By.xpath("//div/ul/li[@id='menu_documentation1']"));
		}catch(Exception e)
		{
		...
		try{
		chromedriver.findElement(By.xpath("//div/ul/li[@id='menu_support1']"));
		}catch(Exception e)
		{
		...
		chromedriver.findElement(By.id("q")).sendKeys("Selenium");
